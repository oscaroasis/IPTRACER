...
function upd() {
  ...
  sleep(1);
  system("cd ~/ && git clone https://github.com/oscar-oasis/IPTRACER.git");
  system("cd ~/ && sudo git clone https://github.com/oscar-oasis/IPTRACER.git");
